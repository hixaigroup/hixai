 ...
 *
 * This is placed on `globalThis.__hixaiPluginBridge__` and consumed by
...
declare global {
  ...
  var __hixaiPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__hixaiPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__hixaiPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
