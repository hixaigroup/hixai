...
import { AGENT_ADAPTER_TYPES } from "@hixai/shared";
import type {
  Agent,
...
// Canonical type lives in @hixai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@hixai/adapter-utils";
import type { CreateConfigValues } from "@hixai/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        HIXAI_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
