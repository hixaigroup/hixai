...
import { buildProjectMentionHref, parseProjectMentionHref } from "@hixai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("hixai-project-mention-chip");
      ...
      link.classList.add("hixai-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative hixai-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("hixai-mdxeditor", !bordered && "hixai-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "hixai-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
