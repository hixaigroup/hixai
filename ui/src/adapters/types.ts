...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@hixai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@hixai/adapter-utils").TranscriptEntry[];
