...
import type { HixAIPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@hixai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: HixAIPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@hixai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
