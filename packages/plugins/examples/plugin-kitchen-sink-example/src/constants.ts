import type { PluginLauncherRegistration } from "@hixai/plugin-sdk";

export const PLUGIN_ID = "hixai-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".hixai-kitchen-sink-demo.txt",
} as const;
