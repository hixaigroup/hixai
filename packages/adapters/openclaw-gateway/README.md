...
This document describes how `@hixai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into HixAI logs/transcript parsing
