...
POST /api/companies/{companyId}/projects
{
  ...
  "workspace": {
    "name": "hixai-mobile",
    "cwd": "/Users/me/hixai-mobile",
    "repoUrl": "https://github.com/acme/hixai-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `hixai-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
