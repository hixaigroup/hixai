/**
 * esbuild configuration for building the hixai CLI for npm.
 *
 * Bundles all workspace packages (@hixai/*) into a single file.
...
// to npm and resolved at runtime (e.g. @hixai/server uses dynamic import).
