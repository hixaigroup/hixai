...
import { models as codexFallbackModels } from "@hixai/adapter-codex-local";
import { models as cursorFallbackModels } from "@hixai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@hixai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.HIXAI_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.HIXAI_OPENCODE_COMMAND = "__hixai_missing_opencode_command__";
