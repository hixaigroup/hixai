...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@hixai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: HIxAIPluginManifestV1, pluginDbId?: string): void;
