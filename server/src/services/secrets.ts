...
import { companySecrets, companySecretVersions } from "@hixai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@hixai/shared";
import { envBindingSchema } from "@hixai/shared";
