...
hixai publish cliphub my-company
```
...
3. Install just that agent: `hixai install cliphub:acme/senior-python-eng --agent`
...
- [ ] `hixai install cliphub:<publisher>/<slug>` CLI command
