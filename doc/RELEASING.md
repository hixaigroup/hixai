...
2. **npm** — `hixai` and public workspace packages are published
...
./scripts/release-start.sh minor --worktree-dir ../hixai-release-0.4.0
...
HIXAI_PORT=3234 ./scripts/clean-onboard-ref.sh
./scripts/clean-onboard-ref.sh HEAD
```

Minimum checks:

- `npx hixai@canary onboard` installs
...
- [ ] `npm view hixai@latest version` matches the new stable version
