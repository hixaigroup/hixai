...
The CLI package, `hixai`, imports code from workspace packages such as:
...
- `npx hixai@canary onboard` can install them explicitly
- `npx hixai onboard` continues to resolve `latest`
