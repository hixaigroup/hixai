...
## 8. New Skill: `hixai-create-agent`

Create new skill directory:

- `skills/hixai-create-agent/SKILL.md`
...
Also update `skills/hixai/SKILL.md` to reference this skill for hiring workflows.
...
- `hixai-create-agent` skill + docs updates
